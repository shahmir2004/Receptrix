...
const featureCards = [
  ...
  },
  {
    ...
    badgeColor: '#22d3ee',
    title: 'Safe Call Outcomes',
    description: 'Appointments, transfers, and missed-call states are tracked without saving medical call transcripts.',
    ctaText: 'See controls',
    ctaHref: '#features',
