    ...
    <div className="relative flex min-h-screen items-center justify-center bg-black px-4 py-12">
      ...
      >
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-sm text-white/50">Start automating your calls in minutes</p>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-white/40">
          ...
          <Link to="/signin" className="text-indigo-400 hover:text-indigo-400 transition-colors">
            Sign in
          </Link>
        </p>
